...
toolbox.decorate("mate", gp.staticLimit(
    key=operator.attrgetter('height'), max_value=3))
...
results, log = algorithms.eaSimple(
    pop, toolbox, cxpb=1.0, mutpb=0.8, ngen=100, stats=stats, halloffame=hof, verbose=True)

print('\nMSE = {}, f(x, y) = {}'.format(eval_func(hof[0], entradas, salidas)[0], str(hof[0])))
